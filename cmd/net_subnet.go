...
func init() {
	...
	netSubnetCmd.Flags().IntVarP(&netSubnetCIDRFlag, "cidr", "m", 0, "new CIDR mask")
	netSubnetCmd.Flags().BoolVarP(&netSubnetViewFlag, "view", "V", false, "get expanded view of subnets")
}
