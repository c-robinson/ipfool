...
func init() {
	...
	v6IIDCmd.Flags().StringVarP(&counter, "counter", "c", "1", "monotonically incrementing number")
	v6IIDCmd.Flags().StringVarP(&neighbor, "neighbor", "n", "", "MAC address of neighbor")
	v6IIDCmd.Flags().StringVarP(&secret, "secret", "s", "", "closely held secret key (or garbage)")
}
